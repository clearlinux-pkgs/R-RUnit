...
Source0  : https://cran.r-project.org/src/contrib/RUnit_0.4.31.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1521174717
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library RUnit|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
